...
class HypothesisTesterTest {
    ...
    @Test
    void testHypothesis() {
        ArrayList<Double> small_data = new ArrayList<Double>(Arrays.asList(1.0d, 1.0d, 1.0d, 2.0d, 3.0d, 4.0d, 2.0d, 4.0d));
        ...
        assertEquals(true, result1.isTestPassed());
        ...
        assertEquals(true, result2.isTestPassed());
        ...
        assertEquals(false, result3.isTestPassed());
        assertEquals(0.1f, result3.getExpectedSignificance());
    }

    @Test
    void calculateSignificance() {
        ArrayList<Double> small_data = new ArrayList<Double>(Arrays.asList(1d,3.0d, 2.5d, 2.0d,4d,5d,1d));
        // test small dataset
        float mu = 3;
        HypothesisTester tester = new HypothesisTester();
        ...
        //test large dataset
        ArrayList<Double> large_data = new ArrayList<Double>(Arrays.asList(1d,3.0d, 2.5d, 2.0d,4d,5d,1d, 4d,3d,10d,5d,7d,8d,4d,11d,12d,3d,4d,5d,5d,6d,8d,9d,10d,11d,15d,13d,2d,1d,3.0d, 2.5d, 2.0d,4d,5d,1d, 4d,3d,10d,5d,7d,8d,4d,11d,12d,3d,4d,5d,5d,6d,8d,9d,10d,11d,15d,13d,2d));
